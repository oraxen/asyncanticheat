...
**[⬇️ Download Latest Release](https://github.com/oraxen/asyncanticheat/releases/download/0.1.0/async-anticheat-0.1.0.jar)**

Or browse all versions on the [GitHub releases](https://github.com/oraxen/asyncanticheat/releases) page.

{/* TODO: Once we have more releases, use the stable latest URL:
https://github.com/oraxen/asyncanticheat/releases/latest/download/async-anticheat.jar */}
