...
| Folia | ✅ Full support |
| BungeeCord / Velocity | ❌ Install on backend servers ([see Network Setup](/docs/installation/network)) |
...
2. Start your server
3. **First-time only:** The plugin will automatically download [PacketEvents](https://github.com/retrooper/packetevents) via [Hopper](https://github.com/oraxen/hopper). If prompted, restart the server once.
...
3. You can manually download [PacketEvents](https://modrinth.com/plugin/packetevents) and place it in `/plugins/`
