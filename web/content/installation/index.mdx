...
2. Start your server
3. **First-time only:** The plugin will automatically download and load [PacketEvents](https://github.com/retrooper/packetevents) via [Hopper](https://github.com/oraxen/hopper). No restart required!
